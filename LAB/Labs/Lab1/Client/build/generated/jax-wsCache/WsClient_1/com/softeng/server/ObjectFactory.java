 ...
 * generated in the com.softeng.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetClientsResponse_QNAME = new QName("http://server.softeng.com/", "getClientsResponse");
    private final static QName _GetClients_QNAME = new QName("http://server.softeng.com/", "getClients");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.softeng.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.softeng.com/", name = "getClientsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.softeng.com/", name = "getClients")
