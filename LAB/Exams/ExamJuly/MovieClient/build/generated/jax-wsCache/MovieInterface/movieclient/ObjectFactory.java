 ...
 * generated in the movieclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetAllDirectors_QNAME = new QName("http://moviews.july.softeng.com/", "getAllDirectors");
    private final static QName _GetAllDirectorsResponse_QNAME = new QName("http://moviews.july.softeng.com/", "getAllDirectorsResponse");
    private final static QName _GetDirector_QNAME = new QName("http://moviews.july.softeng.com/", "getDirector");
    private final static QName _GetAllMoviesResponse_QNAME = new QName("http://moviews.july.softeng.com/", "getAllMoviesResponse");
    private final static QName _GetMovieResponse_QNAME = new QName("http://moviews.july.softeng.com/", "getMovieResponse");
    private final static QName _GetDirectorResponse_QNAME = new QName("http://moviews.july.softeng.com/", "getDirectorResponse");
    private final static QName _GetMovie_QNAME = new QName("http://moviews.july.softeng.com/", "getMovie");
    private final static QName _GetAllMovies_QNAME = new QName("http://moviews.july.softeng.com/", "getAllMovies");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: movieclient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://moviews.july.softeng.com/", name = "getAllDirectors")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://moviews.july.softeng.com/", name = "getAllDirectorsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://moviews.july.softeng.com/", name = "getDirector")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://moviews.july.softeng.com/", name = "getAllMoviesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://moviews.july.softeng.com/", name = "getMovieResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://moviews.july.softeng.com/", name = "getDirectorResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://moviews.july.softeng.com/", name = "getMovie")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://moviews.july.softeng.com/", name = "getAllMovies")
