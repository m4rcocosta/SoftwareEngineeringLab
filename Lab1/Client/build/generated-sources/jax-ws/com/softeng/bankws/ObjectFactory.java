 ...
 * generated in the com.softeng.bankws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOperationsByClientIDResponse_QNAME = new QName("http://bankws.softeng.com/", "getOperationsByClientIDResponse");
    private final static QName _GetOperationsByClientID_QNAME = new QName("http://bankws.softeng.com/", "getOperationsByClientID");
    private final static QName _GetOperationDetailsByID_QNAME = new QName("http://bankws.softeng.com/", "getOperationDetailsByID");
    private final static QName _GetOperationDetailsByIDResponse_QNAME = new QName("http://bankws.softeng.com/", "getOperationDetailsByIDResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.softeng.bankws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankws.softeng.com/", name = "getOperationsByClientIDResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankws.softeng.com/", name = "getOperationsByClientID")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankws.softeng.com/", name = "getOperationDetailsByID")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankws.softeng.com/", name = "getOperationDetailsByIDResponse")
