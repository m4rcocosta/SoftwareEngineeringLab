...
@WebService(endpointInterface="com.softeng.bankws.BankIFace")
public class BankImpl implements BankIFace{
    ...
    public BankImpl() {
        ...
        operationDB.put(3, "[3,2,2019-03-18,400,riparazione motorino]");
    ...
    public String[] getOperationsByClientID(int ClientID) {
        ...
        while(it.hasNext()){
            ...
            String [] st = aux.split(",");
            if(Integer.parseInt(st[1]) == ClientID) result.add(st[0]);
        }
